...
+-----------------------+----------------------------------------------------+
| Inferior (or caudal)  | **Toward the Tail**                                |
+-----------------------+----------------------------------------------------+
| Lateral               | **Away from the Midline**                          |
+-----------------------+----------------------------------------------------+
| Medial                | **Toward the Midline**                             |
+-----------------------+----------------------------------------------------+
| Proximal              | **Toward an Attached Base (Shoulder to Wrist)**    |
+-----------------------+----------------------------------------------------+
| Distal                | **Away from an attached Base (Fingers to Wrist)**  |
+-----------------------+----------------------------------------------------+
...
| Term        | Definition                                      |
|-------------|-------------------------------------------------|
| Cranial     | **Around the Skull**                            |
| Abdominal   | **Around the Abdomen**                          |
| Pericardial | **Around the Heart (Thoracic)**                 |
| Pleural     | **Around the Lungs (Thoracic)**                 |
| Ventral     | **Around the Body (Both Thoracic and Abdomen)** |

### Body Planes

| Term               | Definition                |
|--------------------|---------------------------|
| Sagittal plane     | **Right from Left**       |
| Midsagittal plane  | **In the Middle (Equal)** |
| Parasagittal plane | **Off Centered**          |
| Frontal plane      | **Front to Back**         |
| Transverse plane   | **Horizontal**            |
| Oblique plane      | **Angled**                |
...
| b             | **Vertebral**                      |
| c             | **Pleural**                        |
| d             | **Pericardial within Mediastinum** |
| e             | **Diaphragm**                      |
...
+=======================+======================================================================================================================+=====================================================+
| 1                     | **Integumentary- Body Structure/Sensory Receptors**                                                                  | **Hair/Skin/Nails**                                 |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 2                     | **Skeletal- Supports Body/Enable Movement w/Muscular**                                                               | **Cartilage/Bones/Joints**                          |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 3                     | **Muscular- Enables Movement/Maintain Body Temperature**                                                             | **Skeletal Muscles/Tendons**                        |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 4                     | **Nervous- Detect and Process Sensory Information/Activates Body response**                                          | **Brain, Spinal Cord, Peripheral Nerves**           |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 5                     | **Endocrine- Secrete Hormones/Regulate Body Processes**                                                              | **Pituitary, Adrenal, and Thyroid Glands/Pancreas** |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 6                     | **Cardiovascular- Delivers Oxygen and Nutrients to Tissues/Equalizes Body Temperature**                              | **Heart/Blood Vessels**                             |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 7                     | **Lymphatic- Returns Fluids to Blood/ Defends Against Pathogens**                                                    | **Spleen/Thymus/Lymph Nodes**                       |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 8                     | **Respiratory- Carbon Dioxide from the Body/Oxygen to the body**                                                     | **Nasal Passage/Trachea/Lungs**                     |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 9                     | **Digestive- Processes food for use by the body/removes waste**                                                      | **Stomach/Liver/Gall Bladder**                      |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 10                    | **Urinary- Controls water balance in the body/removes waste from the blood and excretes them**                       | **Kidneys/Urinary Bladder**                         |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 11a                   | **Male Reproductive- Produce Sex Hormones and Gametes/Deliver Gametes to female**                                    | **Epididymis/Testes**                               |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| 11b                   | **Female Reproductive- Produce Sex Hormones and Gametes/ Supports Embryo/fetus until birth/Produce milk for infant** | **Mammary Glands/Ovaries/Uterus**                   |
+-----------------------+----------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
...
### **Anatomical position:** The standard reference position used in anatomy to describe the location of body parts.
...
#####   The feet are flat on the floor and pointing forward
...
#### **Prone position: A body position in which a person lies flat on the stomach, with their face turned downward.**

**Supine position: A body position in which a person lies flat on the back, with their face turned upward.**
...
![](images/clipboard-122917876.png)**Figure 1.4** Unlabeled directional terms diagram.

Indicate in the boxes provided the deep and superficial positions.

![](images/clipboard-3690528773.png)**Figure 1.5** Sagittal section of the head. The subject is an 18-year-old male who had blunt trauma to the head after a 25 m long jump during [motocross.](https://en.wikipedia.org/wiki/Motocross)
...
| Quadrants                         | Organs                                                                                                                                       |
+===================================+==============================================================================================================================================+
| Right upper quadrant              | Liver (right lobe), Gallbladder, Part of pancreas, Right kidney, Portions of small and large intestines (duodenum, hepatic flexure of colon) |
+-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| Right lower quadrant              | Appendix, Cecum, Part of small intestine (ileum), Right ovary and fallopian tube (in females), Right ureter                                  |
+-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| Left upper quadrant               | Stomach, Spleen, Left lobe of liver, Part of pancreas, Left kidney, Portions of small and large intestines (splenic flexure of colon)        |
+-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| Left lower quadrant               | Part of small intestine, Descending colon, Sigmoid colon, Left ovary and fallopian tube (in females), Left ureter                            |
+-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
...
| Regions                           | Organs                                                                                |
+===================================+=======================================================================================+
| Left hypochondriac                | Spleen, part of stomach, tail of pancreas, left kidney, parts of colon                |
+-----------------------------------+---------------------------------------------------------------------------------------+
| Epigastric                        | Stomach, liver (left lobe), pancreas, duodenum, adrenal glands                        |
+-----------------------------------+---------------------------------------------------------------------------------------+
| Right hypochondriac               | Liver (right lobe), gallbladder, right kidney, part of small intestine                |
+-----------------------------------+---------------------------------------------------------------------------------------+
| Left lumbar                       | Descending colon, left kidney, part of small intestine                                |
+-----------------------------------+---------------------------------------------------------------------------------------+
| Umbilical                         | Small intestine (jejunum & ileum), transverse colon, lower part of duodenum           |
+-----------------------------------+---------------------------------------------------------------------------------------+
| Right lumbar                      | Ascending colon, right kidney, part of small intestine                                |
+-----------------------------------+---------------------------------------------------------------------------------------+
| Left iliac                        | Sigmoid colon, left ovary and fallopian tube (in females), part of small intestine    |
+-----------------------------------+---------------------------------------------------------------------------------------+
| Hypogastric                       | Urinary bladder, sigmoid colon, uterus (in females), part of small intestine          |
+-----------------------------------+---------------------------------------------------------------------------------------+
| Right iliac                       | Cecum, appendix, right ovary and fallopian tube (in females), part of small intestine |
+-----------------------------------+---------------------------------------------------------------------------------------+
...
+-----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 3                                 | **The nose is located Medial and Anterior to the ears.**                                                                                                                                    |
+-----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 6                                 | **A wound on the elbow would be Surface to the elbow.**                                                                                                                                     |
+-----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+================================================================================================================================================================================+=====================================================+========================================================================================================+
| Example: Standing from a Half Spinal Twist with the feet placed to the left, the torso twisted away from you and the head facing at a slight angle to the right, away from you | ![Figure 1.6](images/fig1.6.jpeg){alt="Figure 1.6"} | Example:                                                                                               |
|                                                                                                                                                                                |                                                     |                                                                                                        |
...
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+--------------------------------------------------------------------------------------------------------+
| 1: From lying face-up on the ground with their head, back, hands, and feet on the floor with both knees bent                                                                   | ![Figure 1.7](images/fig1.7.jpeg){alt="Figure 1.7"} | · **Extend both knees to straighten the lower limbs.**                                                 |
|                                                                                                                                                                                |                                                     |                                                                                                        |
|                                                                                                                                                                                |                                                     | · **Extend the hips to bring the thighs into alignment with the trunk.**                               |
|                                                                                                                                                                                |                                                     |                                                                                                        |
|                                                                                                                                                                                |                                                     | · **Adduct the upper limbs so the arms are positioned at the sides.**                                  |
|                                                                                                                                                                                |                                                     |                                                                                                        |
|                                                                                                                                                                                |                                                     | · **Supinate the forearms to position the palmar regions anteriorly.**                                 |
|                                                                                                                                                                                |                                                     |                                                                                                        |
|                                                                                                                                                                                |                                                     | · **Move to an upright standing position with the head facing anteriorly and feet flat on the floor.** |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+--------------------------------------------------------------------------------------------------------+
| 2: From a seated position on the floor with their legs straight and arms folded across their chest                                                                             | ![Figure 1.8](images/fig1.8.jpeg){alt="Figure 1.8"} | · **Extend the hips and knees to rise to a standing position.**                                        |
|                                                                                                                                                                                |                                                     |                                                                                                        |
|                                                                                                                                                                                |                                                     | · **Unfold and extend the upper limbs.**                                                               |
|                                                                                                                                                                                |                                                     |                                                                                                        |
|                                                                                                                                                                                |                                                     | · **Adduct the arms so they rest at the sides of the body.**                                           |
|                                                                                                                                                                                |                                                     |                                                                                                        |
|                                                                                                                                                                                |                                                     | · **Supinate the forearms so the palmar regions face anteriorly.**                                     |
|                                                                                                                                                                                |                                                     |                                                                                                        |
|                                                                                                                                                                                |                                                     | · **Align the head to face anteriorly with the body upright and feet pointing forward.**               |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+--------------------------------------------------------------------------------------------------------+
...
-   **Median (Midsagittal) plane**: a sagittal plane that divides the body into equal left and right halves.
-   **Parasagittal plane**: a sagittal plane that divides the body into unequal left and right portions.
...
![](images/clipboard-4286878805.png)**Figure 1.9**. Human Anatomical Planes.
...
Plane: **Plane: Transverse/Horizontal**
...
![](images/clipboard-3607209817.png)

#### **Table 1.4. Abdominal Regions**

![](images/clipboard-3511330139.png)
...
| Organ System                      | Organs                                              |
+===================================+=====================================================+
| **1 Integumentary**               | **Hair/Skin/Nails**                                 |
+-----------------------------------+-----------------------------------------------------+
| **2 Skeletal**                    | **Cartilage/Bones/Joints**                          |
+-----------------------------------+-----------------------------------------------------+
| **3 Muscular**                    | **Skeletal Muscles/Tendons**                        |
+-----------------------------------+-----------------------------------------------------+
| **4 Nervous**                     | **Brain/Spinal Cord/Peripheral Nerves**             |
+-----------------------------------+-----------------------------------------------------+
| **5 Endocrine**                   | **Pituitary, Adrenal, and Thyroid Glands/Pancreas** |
+-----------------------------------+-----------------------------------------------------+
| **6 Cardiovacular**               | **Heart/Blood Vessels**                             |
+-----------------------------------+-----------------------------------------------------+
| **7 Lymphatic**                   | **Spleen/Thymus/Lymph Nodes**                       |
+-----------------------------------+-----------------------------------------------------+
| **8 Respiratory**                 | **Nasal Passage/Trachea/Lungs**                     |
+-----------------------------------+-----------------------------------------------------+
| **9 Digestive**                   | **Stomach/Liver/Gall Bladder**                      |
+-----------------------------------+-----------------------------------------------------+
| **10 Urinary**                    | **Kidneys/Urinary Bladder**                         |
+-----------------------------------+-----------------------------------------------------+
| **11a Male Reproductive**         | **Epididymis/Testes**                               |
+-----------------------------------+-----------------------------------------------------+
| **11b Female Reproductive**       | **Mammary Glands/Ovaries/Uterus**                   |
+-----------------------------------+-----------------------------------------------------+
...
-   The breasts are **anterior** to the lungs.
...
-   The lips are **inferior** and **medial** to the ears.
...
-   **Orbital** refers to the eye socket.

-   **Buccal** refers to the cheek.

### Planes

-   The **frontal (coronal) plane** separates the anterior and posterior portions of an object.
-   The **transverse (horizontal) plane** separates the superior and inferior portions of an object.
