...
| Term | Definition |
|----|----|
| Cytoplasm | All material between plasma membrane and nucleus; includes organelles and cytosol |
| Cytosol | Fluid portion of cytoplasm |
| Organelles | Specialized structures that perform cell functions |
...
| Golgi apparatus              | Modifies, packages, ships molecules   |
| Mitochondrion                | ATP production                        |
| Lysosomes                    | Intracellular digestion               |
| Peroxisomes                  | Detoxification, breakdown of peroxide |
| Microfilaments               | Structural support, movement          |
| Microtubules                 | Cell shape, transport, spindle fibers |
...
-   **Passive Transport:** movement without ATP down concentration gradient\
-   **Active Transport:** movement requiring ATP against gradient\
...
-   **Interphase**:\
    The period of the cell cycle when the cell grows, carries out normal functions, and prepares for division. It includes G1, S, and G2 phases.

-   **G1 phase (Gap 1)**:\
    The cell increases in size, produces proteins and organelles, and performs its normal metabolic functions.

-   **S phase (Synthesis)**:\
    DNA is replicated, resulting in duplicated chromosomes (sister chromatids).

-   **G2 phase (Gap 2)**:\
    The cell continues to grow, produces proteins needed for mitosis, and checks that DNA replication is complete and accurate.
...
|----|----|----|
| **Prophase** | Chromatin condenses into chromosomes; nuclear envelope breaks down; spindle fibers form | Chromosomes become visible as thick, condensed structures; nucleus begins to disappear |
| **Metaphase** | Chromosomes align at the cell’s equator; spindle fibers attach to centromeres | Chromosomes lined up in the middle (metaphase plate); spindle fibers clearly visible |
| **Anaphase** | Sister chromatids separate and are pulled to opposite poles | Chromatids appear V-shaped as they move toward opposite ends of the cell |
| **Telophase** | Nuclear envelopes reform around each set of chromosomes; chromosomes decondense | Two nuclei begin to form; chromosomes become less visible (more diffuse) |
| **Cytokinesis** | Cytoplasm divides to form two daughter cells | Cell membrane pinches (cleavage furrow) in animal cells; two separate cells form |
...
| c     | Hydrophobic (nonpolar) tails                 |
| d     | Integral (transmembrane) protein             |
| e     | Peripheral protein                           |
| f     | Cholesterol                                  |
| g     | Carbohydrate chain (glycoprotein/glycolipid) |
...
-   **Cytokinesis**:\
    The division of the cytoplasm to form two separate daughter cells at the end of cell division.

-   **Interphase**:\
    The stage of the cell cycle in which the cell grows, performs normal functions, and replicates its DNA in preparation for division (includes G1, S, and G2 phases).

-   **M-phase (Mitotic phase)**:\
    The phase of the cell cycle in which the cell divides, including mitosis (division of the nucleus) and cytokinesis (division of the cytoplasm).

-   **Chromosome**:\
    A tightly coiled structure of DNA and proteins that carries genetic information, visible during cell division.

-   **Chromatin**:\
    The uncoiled, thread-like form of DNA found in the nucleus when the cell is not dividing.

------------------------------------------------------------------------

## Mitosis

List the stages and processes of mitosis in M-phase:

-   **Prophase**: Chromosomes condense; nuclear envelope breaks down; spindle fibers form.\
-   **Metaphase**: Chromosomes align at the center (metaphase plate) of the cell.\
...
The cell membrane is composed of three main types of macromolecules:
...
These components form the **fluid mosaic structure** of the membrane.
...
-   Form a **bilayer** with hydrophilic heads facing outward and hydrophobic tails facing inward\
-   Create a **selectively permeable barrier**\
-   Provide the basic structural framework of the membrane

#### Cholesterol

-   Maintains **membrane fluidity and stability**\
-   Prevents the membrane from becoming too rigid in cold temperatures and too fluid in warm temperatures

#### Proteins

-   Function in **transport** (channels and carrier proteins)\
-   Act as **receptors** for cell communication\
...
|----|----|----|
| Plasma membrane | 6 | Selectively permeable barrier controlling movement in and out of the cell |
| Cilia | — | Moves substances across the cell surface (not clearly shown on this model) |
| Microvilli | 15 | Increases surface area for absorption |
| Nucleolus | 2 | Produces ribosomes |
| Nucleus | 1 | Contains DNA and controls cell activities |
| Nuclear envelope | 1 | Surrounds nucleus and regulates transport |
| Nuclear pore | 14 | Allows movement of materials between nucleus and cytoplasm |
| Ribosome | 18 | Site of protein synthesis |
| Vesicle | 17 | Transports and stores materials |
| Peroxisome | 21 | Detoxifies harmful substances and breaks down fatty acids |
| Lysosome | 19 | Digests waste and cellular debris |
| Golgi apparatus | 20 | Modifies, sorts, and packages proteins and lipids |
| Mitochondrion | 3 | Produces ATP (energy) |
| Rough endoplasmic reticulum | 4 | Synthesizes proteins (ribosome-studded) |
| Smooth endoplasmic reticulum | 5 | Synthesizes lipids and detoxifies substances |
| Centriole | 16 | Involved in cell division and spindle formation |
...
| Name | Description |
|----|----|
| 1\) **Interphase** | f\) The summary of the G1, S, G2 phases |
| 2\) **G2 Phase** | e\) The cell grows a second time to reorganize its contents in preparation for mitosis |
| 3\) **Metaphase** | i\) Occurs when the cell's chromosomes condense and align in the center of the dividing cell |
| 4\) **S phase** | d\) Occurs when the cell synthesizes a complete copy of the DNA |
| 5\) **Mitosis (M phase)** | g\) The process when the cell separates its DNA into two sets and divides its cytoplasm, forming two new cells |
| 6\) **Prophase** | a\) The first stage of mitosis |
| 7\) **G1 phase** | c\) The cell grows physically larger, making the molecular building blocks it will need |
| 8\) **Cytokinesis** | b\) The division of the cytoplasm of a cell |
| 9\) **Telophase** | j\) The final stage in cell division |
| 10\) **Anaphase** | h\) Observed when chromosomes move toward opposite ends of the spindle |
...
**3.** **Nuclear envelope**\
A large organelle in eukaryotic organisms which protects the DNA.

**5.** **Cell membrane**\
A network of lipids and proteins that forms the boundary between a cell's contents and the outside of the cell.

**6.** **Lysosomes**\
Specialized vesicles within cells that digest large molecules using hydrolytic enzymes.

**7.** **Peroxisomes**\
Membrane-bound organelles involved in lipid metabolism and the conversion of reactive oxygen species such as hydrogen peroxide into safer molecules like water and oxygen.

### Down

**1.** **Nucleolus**\
The site in the nucleus where the several different parts of ribosomes are produced and exported.

**2.** **Centrioles**\
Small structures made of microtubules which exist as part of the centrosome.

**4.** **Golgi apparatus**\
An organelle in eukaryotic organisms that moves molecules from the endoplasmic reticulum to their destination.

**8.** **Ribosome**\
An organelle in the cytoplasm of a living cell; the site of protein synthesis.
...
| 1\) **Interphase** | f\) The summary of the G1, S, G2 phases |
| 2\) **G2 Phase** | e\) The cell grows a second time to reorganize its contents in preparation for mitosis |
| 3\) **Metaphase** | i\) Occurs when chromosomes align in the center of the dividing cell |
| 4\) **S phase** | d\) Occurs when the cell synthesizes a complete copy of the DNA |
| 5\) **Mitosis (M phase)** | g\) The process when the cell separates its DNA into two sets and divides its cytoplasm, forming two new cells |
| 6\) **Prophase** | a\) The first stage of mitosis |
| 7\) **G1 phase** | c\) The cell grows physically larger, making molecular building blocks |
| 8\) **Cytokinesis** | b\) The division of the cytoplasm of a cell |
| 9\) **Telophase** | j\) The final stage in cell division |
| 10\) **Anaphase** | h\) Observed when chromosomes move toward opposite ends of the spindle |
...
| 2      | Nucleolus                         |
| 3      | Nuclear pore                      |
| 4a     | Nuclear envelope (inner membrane) |
| 4b     | Nuclear envelope (outer membrane) |
| 5      | Cytoplasm                         |
| 6      | Ribosome (on nuclear envelope)    |
