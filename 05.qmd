...
| Term | Definition |
|----|----|
| **Epidermis** | Outer layer of the skin made of keratinized stratified squamous epithelium; provides protection |
| **Stratum corneum** | Outermost layer of dead, keratinized cells that protect against water loss and damage |
| **Stratum lucidum** | Thin, clear layer found only in thick skin (palms/soles) |
| **Stratum granulosum** | Layer where keratinization begins; cells accumulate keratin and die |
| **Stratum spinosum** | Layer of cells that provide strength and flexibility; contains desmosomes |
| **Stratum basale (germinativum)** | Deepest layer; actively dividing cells that produce new keratinocytes |

**Dermal Layer**

| Term | Definition |
|----|----|
| **Dermis** | Connective tissue layer beneath epidermis; provides strength, elasticity, and nourishment |
| **Papillary layer** | Superficial dermal layer; contains areolar tissue, capillaries, and dermal papillae |
| **Reticular layer** | Deeper dermal layer; dense irregular connective tissue with collagen and elastic fibers |

| Term | Definition |
|----|----|
| **Subcutaneous Layer (Hypodermis)** | Layer beneath dermis composed mainly of adipose tissue; provides insulation, cushioning, and energy storage |

**Integumentary Structures**

| Term | Definition |
|----|----|
| **Dermal papillae** | Finger-like projections that increase surface area and anchor epidermis to dermis |
| **Hair shaft** | Visible portion of hair above the skin surface |
| **Hair root** | Portion of hair below the skin surface |
| **Hair follicle** | Structure that surrounds and produces hair |
| **Pore** | Opening on the skin surface for sweat or oil release |
| **Arrector pili muscle** | Small muscle that causes hair to stand up (goosebumps) |
| **Sebaceous gland** | Produces sebum (oil) to lubricate skin and hair |
| **Merocrine (eccrine) sweat gland** | Produces watery sweat for temperature regulation |
| **Apocrine sweat gland** | Produces thicker sweat; active during stress and puberty (axillary/genital regions) |
...
| **Melanocyte** | Produces melanin pigment for skin color and UV protection |
...
-   **4:** Epidermis\
-   **5:** Dermis\
-   **6:** Subcutaneous layer (Hypodermis)
...
|----|----|
| **Stratum corneum** | Outermost layer; composed of dead, keratinized cells; provides protection and prevents water loss |
| **Stratum lucidum** | Thin, clear layer found only in thick skin (palms and soles); adds extra protection |
| **Stratum granulosum** | Cells accumulate keratin and begin to die; important for waterproofing |
| **Stratum spinosum** | Provides strength and flexibility; cells connected by desmosomes |
| **Stratum basale (germinativum)** | Deepest layer; actively dividing cells produce new keratinocytes; contains melanocytes |
...
|----|----|
| **Stratum corneum** | Outermost layer of dead, flattened, keratinized cells; provides protection and reduces water loss |
| **Stratum lucidum** | Thin, transparent layer present only in thick skin (palms and soles); adds extra protection |
| **Stratum granulosum** | Cells begin keratinization and die; contains keratohyalin granules for waterproofing |
| **Stratum spinosum** | Several layers of cells connected by desmosomes; provides strength and flexibility |
| **Stratum basale** | Deepest layer; mitotically active cells produce new keratinocytes; contains melanocytes |
...
|----|----|
| **Dermal papillae** | Increase surface area for attachment between dermis and epidermis; contain capillaries and sensory receptors |
| **Pore** | Opening on the skin surface that allows sweat or sebum to reach the exterior |
| **Arrector pili muscle** | Contracts to raise hair (goosebumps); helps regulate temperature |
| **Sebaceous gland** | Produces sebum (oil) to lubricate and protect skin and hair |
| **Merocrine (eccrine) sweat gland** | Produces watery sweat for thermoregulation and waste excretion |
| **Apocrine sweat gland** | Produces thicker sweat; becomes active during puberty; associated with scent |
| **Free nerve ending** | Detects pain, temperature, and some touch sensations |
| **Meissner's (tactile) corpuscle** | Sensitive to light touch and texture |
| **Pacinian (pressure) corpuscle** | Detects deep pressure and vibration |
| **Keratinocyte** | Produces keratin; provides protection and waterproofing |
| **Melanocyte** | Produces melanin pigment for skin color and UV protection |
| **Epidermis** | Outer protective layer of skin; prevents water loss and protects against environmental damage |
...
-   **Dermal papillae**:\
    Finger-like projections of the dermis that increase surface area for attachment to the epidermis; contain capillaries and sensory receptors.

-   **Hair shaft**:\
    The visible portion of hair above the skin surface; provides protection and assists with sensation.

-   **Hair root**:\
    The portion of hair below the skin surface; anchors the hair within the follicle and supports growth.

-   **Hair follicle**:\
    A tubular structure in the skin that surrounds the hair root and produces hair.

-   **Pore**:\
    An opening on the skin surface that allows sweat or sebum (oil) to reach the exterior.

-   **Arrector pili muscle**:\
    A small smooth muscle attached to the hair follicle; contracts to raise the hair (goosebumps) and helps with temperature regulation.
...
-   **Papillary layer**: Superficial layer made of areolar connective tissue; contains capillaries, dermal papillae, and sensory receptors.\
-   **Reticular layer**: Deeper layer made of dense irregular connective tissue; provides strength, elasticity, and contains glands, hair follicles, and blood vessels.

------------------------------------------------------------------------

### List three major types of glands associated with the integumentary system and describe their function

-   **Sebaceous glands**: Produce sebum (oil) to lubricate and protect the skin and hair.

-   **Merocrine (eccrine) sweat glands**: Produce watery sweat for thermoregulation and excretion of waste.

-   **Apocrine sweat glands**: Produce thicker sweat associated with scent; become active during puberty (found in axillary and genital regions).

------------------------------------------------------------------------

### What are the three protective functions of the integumentary system?

-   **Physical protection**: Acts as a barrier against injury, pathogens, and environmental damage.

-   **Prevention of water loss**: Keratin and lipids reduce dehydration by limiting water evaporation.

-   **UV protection**: Melanin produced by melanocytes protects underlying tissues from harmful ultraviolet radiation.
...
**7.** **Reticular layer**\
The layer which serves to strengthen the skin and provides our skin with elasticity. It contains hair follicles, sweat glands, and sebaceous glands.

**8.** **Stratum granulosum**\
A thin layer of cells in the epidermis lying above the stratum spinosum and below the stratum corneum.
...
**1.** **Stratum corneum**\
The outermost layer of the epidermis comprised of several levels of flattened corneocytes.

**2.** **Papillary layer**\
A more superficial and significantly thinner layer of the dermis, mainly composed of areolar connective tissue.

**3.** **Hypodermis**\
The lowermost layer of the integumentary system in vertebrates.

**4.** **Stratum spinosum**\
A layer of the epidermis composed of polyhedral keratinocytes.

**5.** **Stratum basale**\
The deepest layer of the five layers of the epidermis; a single layer of columnar or cuboidal basal cells.

**6.** **Stratum lucidum**\
A thin, clear layer of dead skin cells in the epidermis, visible only in thick skin.
...
-   **Underlying connective tissue and muscle (depending on depth)**
...
The GP is not concerned because the condition is likely **carotenemia**, which occurs when excess **beta-carotene** (from foods like carrots, sweet potatoes, and squash) accumulates in the skin.

-   This is **harmless** and not the same as jaundice\

-   It results from a diet high in orange/yellow vegetables\

-   The condition will resolve when the diet is more balanced
...
-   **Sweat glands (eccrine)** produce sweat → evaporation cools the body\
-   **Blood vessels in the dermis dilate (vasodilation)** → increases heat loss through the skin\
-   **Hair lies flat** → reduces insulation

These mechanisms help return the body to normal temperature (**homeostasis**).

-   How would you explain why a light skinned individual would be more susceptible to malignant melanoma?

Here is your Table 5.6 completed and converted to Quarto Markdown format:
...
If you want, I can turn this into a practice matching quiz (answers hidden) or a flashcard set to help you study faster.
...
6 a thin, clear layer of dead skin cells in the epidermis named for its translucent appearance only in areas of thick skin (7,7) \## Crossword Puzzle
...
**6.** **Stratum lucidum**\
A thin, clear layer of dead skin cells in the epidermis, visible only in thick skin. Post Lab Activity 5.4
...
Here is your section completed and converted to Quarto Markdown format:
...
### 1. Layers of the Integument (Superficial → Deep)

The layers that would be cut through to retrieve the bullet are:
...
### 2. Infant with Yellow-Orange Skin Tint
...
### 3. Temperature Regulation by the Integumentary System
...
### 4. Susceptibility to Malignant Melanoma in Light-Skinned Individuals
...
## Figure: Layers of the Epidermis (Labeled)

### Epidermal Layers (Superficial → Deep)

-   **Stratum corneum**\
    Outermost layer of flattened, dead keratinized cells

-   **Stratum lucidum** *(thick skin only)*\
    Thin, clear layer of dead cells

-   **Stratum granulosum**\
    Cells undergoing keratinization; contain granules

-   **Stratum spinosum**\
    “Spiny” appearing cells connected by desmosomes

-   **Stratum basale (germinativum)**\
    Deepest layer; mitotically active; produces new cells
...
-   Portion of hair **above the epidermis** \### Hair Root
-   Portion of hair **below the skin surface**
-   Located within the **hair follicle** \### Hair Bulb
-   Enlarged base of the hair root \### Hair Follicle
-   Tubular sheath surrounding the hair root \### Arrector Pili Muscle
-   Small band of **smooth muscle** \### Sebaceous Gland
-   Located next to hair follicle \### Apocrine Sweat Gland
-   Larger, coiled gland
...
|   | Answer |
|----|----|
| a\) | Sebaceous glands – secrete sebum (oil) to lubricate and protect skin and hair |
| b\) | Merocrine (eccrine) sweat glands – produce watery sweat for thermoregulation |
| c\) | Apocrine sweat glands – produce thicker sweat; associated with scent and stress response |
...
|     | Answer                                        |
|-----|-----------------------------------------------|
| a\) | Protection from physical damage and pathogens |
| b\) | Prevention of water loss (dehydration)        |
| c\) | Protection from UV radiation (melanin)        |
...
| c\) | Sweat glands – regulate temperature and excrete waste |
| d\) | Sensory receptors (Meissner’s/Pacinian corpuscles) – detect touch and pressure |
